...
import {
  PurchaseRequestCorrectionTableRow,
  PurchaseRequestCorrectionTableToolbar,
...
export default function PurchaseRequestCorrectionList({ list, isLoading }) {
  const {
    dense,
    page,
    order,
  ...
  const handleViewRow = (id) => {
    navigate(PATH_DASHBOARD.purchase.request.correction(id));
  };
