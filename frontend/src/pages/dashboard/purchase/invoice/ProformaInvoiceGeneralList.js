...
import GeneralTableRow from "src/sections/@dashboard/invoice/list/GeneralTableRow";
import GeneralTableToolbar from "src/sections/@dashboard/invoice/list/GeneralTableToolbar";
...
export default function ProformaInvoiceGeneralList() {
  const {
    dense,
    page,
    order,
