...
import CorrectionTableRow from "src/sections/@dashboard/invoice/list/CorrectionTableRow";
import CorrectionTableToolbar from "src/sections/@dashboard/invoice/list/CorrectionTableToolbar";
...
export default function ProformaInvoiceCorrectionList() {
  const {
    dense,
    page,
    order,
