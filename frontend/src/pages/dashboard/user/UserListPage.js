...
if (
  window.checkPermission("users_and_roles.users.update") ||
  window.checkPermission("users_and_roles.users.delete") ||
...
export default function UserListPage() {
  ...
  const handleEditRow = (id) => {
    navigate(PATH_DASHBOARD.userManagement.user.edit(id));
  };
  const handleViewRow = (id) => {
    navigate(PATH_DASHBOARD.userManagement.user.view(id));
  };
  ...
  return (
    <ViewGuard permission="users_and_roles.users.read" page={true}>
      <Helmet>
      ...
      <Container maxWidth={themeStretch ? false : "lg"}>
        <CustomBreadcrumbs
          ...
          action={
            <ViewGuard permission="users_and_roles.users.create">
              <Button
                component={RouterLink}
                to={PATH_DASHBOARD.userManagement.user.new}
                variant="contained"
