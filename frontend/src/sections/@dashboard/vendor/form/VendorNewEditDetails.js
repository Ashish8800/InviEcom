...
export default function VendorNewEditDetails() {
        ...
        >
          <Stack>
            <Grid container spacing={2}>
              <Grid item xs={3}>
                <RHFSelect size="small" name="salutation" label="Salutation">
          ...
          <RHFSelect size="small" name="currency" label="Currency">
          ...
          <RHFTextField size="small" name="website" label="Website" />
          <RHFTextField size="small" name="pan" label="PAN" />
        </Box>
          ...
          <Card sx={{ backgroundColor: "#fbfbfb", p: 2 }}>
            <Stack gap={1}>
              ...
              <RHFTextField
                ...
                label="Address"
              />
              <RHFTextField size="small" name="billing.city" label="City" />
              <RHFTextField size="small" name="billing.state" label="State" />
              <RHFSelect
                size="small"
                native
          ...
          <Card sx={{ backgroundColor: "#fbfbfb", p: 2 }}>
            <Stack gap={1}>
              ...
              <RHFTextField
                ...
                label="Address"
              />
              <RHFTextField size="small" name="shipping.city" label="City" />
              <RHFTextField size="small" name="shipping.state" label="State" />
              <RHFSelect
                size="small"
                native
