...
const TABLE_HEAD = [
  { id: "title", label: "Policy Title", align: "center" },
  { id: "description", label: "Description", align: "center" },
  { id: "date", label: "Effective Date", align: "center" },
...
export default function Policy() {
  ...
  const handleViewRow = (id) => {
    navigate(PATH_DASHBOARD.user.policy(id));
  };
  ...
  const handleEditRow = (data) => {
    ...
    setPolicyOpen(true);
    // navigate(PATH_DASHBOARD.user.requestedi(id));
  };
