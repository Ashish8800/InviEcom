...
import OrderCreateTableRow1 from "src/sections/@dashboard/salesorder/list/OrderCreateTableRow1.js";
        ...
        <Grid item xs={12} md={6}>
          <Stack sx={{ pt: 4, px: 3 }} spacing={1}>
            ...
            <Stack direction="row">
              ...
              <Typography>S09876543</Typography>
            </Stack>
          </Stack>
        </Grid>
      </Grid>
                ...
                <Scrollbar>
                  ...
                  >
                    ...
                    <TableBody>
                      ...
                      <StyledRowResult sx={{ pl: 3 }}>
                        <TableCell colSpan={4} />

                        <TableCell align="center" sx={{ typography: "body1" }}>
                          <Box sx={{ mt: 2 }} />
                          Subtotal
                        </TableCell>
