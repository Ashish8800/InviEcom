      ...
      <Grid container>
        <Grid item xs={12} md={4}>
          <Stack spacing={2} sx={{ p: 1 }}>
            <RHFSelect small="small" name="purchaseOrderId" label="PO Number*">
                  ...
                  <Stack>
                    <Stack>
                      <Stack direction="row">
                        ...
                        <Typography>
                          {purchaseOrder?.vendorDetails?.vendorDisplayName}
                        </Typography>
                      </Stack>
                      <Stack direction="row">
                        <Typography
                        ...
                        <Typography>{`${
                          purchaseOrder?.vendorDetails?.billing?.address ?? ""
                        } ${
                          purchaseOrder?.vendorDetails?.billing?.city ?? ""
                        } ${
                          purchaseOrder?.vendorDetails?.billing?.state ?? ""
                        } ${
                          purchaseOrder?.vendorDetails?.billing?.country ?? ""
                        } ${
                          purchaseOrder?.vendorDetails?.billing?.pincode ?? ""
                        } `}</Typography>
                      </Stack>
                      <Stack direction="row">
                        <Typography
                        ...
                        <Typography> {purchaseOrder?.pr?.deliverTo}</Typography>
                      </Stack>
                    </Stack>
                  </Stack>
                </Grid>
                <Grid item xs={12} md={6} sx={{ p: 2 }}>
                  <Stack>
                    <Stack direction="row">
                      ...
                      <Typography> {purchaseOrder?.id}</Typography>
                    </Stack>
                    <Stack direction="row">
                      <Typography
                        paragraph
                      ...
                      <Typography>
                        {formateDate(purchaseOrder.createdOn, {
                          withTime: false,
                        })}
                      </Typography>
                    </Stack>
                    <Stack direction="row">
                      ...
                      <Typography>
                        {formateDate(purchaseOrder?.pr?.deliveryDate, {
                          withTime: false,
                        })}
                      </Typography>
                    </Stack>
