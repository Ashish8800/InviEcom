...
} from "src/sections/@dashboard/purchase/order/list";
...
export default function PurchaseOrderVerificationList() {
  const {
    dense,
    page,
    order,
  ...
  const handleViewRow = (id) => {
    navigate(PATH_DASHBOARD.purchase.order.verification(id));
  };
            ...
            <Scrollbar>
              <Table size={dense ? "small" : "medium"} sx={{ minWidth: 800 }}>
                <TableHeadCustom
                  ...
                  numSelected={selected.length}
                  onSort={onSort}
                  // heading="Purchase Order Verification Bucket"
                  headingSx={{
                    color: "#fff",
