...
// @mui
import { Box, Card, Grid, Stack, TableRow, Typography } from "@mui/material";
...
export default function OrderApprovalNewEditDetails({ id }) {
      ...
      <Stack sx={{ mt: 2, p: 3 }}>
        ...
        <Stack direction="row" sx={{ p: 1 }}>
          ...
          <RHFRadioGroup
            ...
            name="status"
            options={[
              { label: " PO Approval", value: "approved" },
