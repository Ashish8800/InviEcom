...
//
import ReceiveNewEditDetails from "./ReceiveNewEditDetails";
...
ReceiveNewEditForm.propTypes = {
  isEdit: PropTypes.bool,
  currentPurchase: PropTypes.object,
};

export default function ReceiveNewEditForm({ isEdit, currentPurchase }) {
  ...
  useEffect(() => {
    if (id != "") PurchaseReceive.get(id).then((res) => console.log(res));
  }, [id]);

  return (
    <FormProvider methods={methods}>
      <Card>
        <ReceiveNewEditDetails />
      </Card>
